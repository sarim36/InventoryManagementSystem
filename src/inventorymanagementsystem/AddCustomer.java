...
public class AddCustomer extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            try{
                Conn conn= new Conn();
                String str = "CALL insert_customer('"+name+"','"+phone+"')";
                ...
                JOptionPane.showMessageDialog(null, "Error adding Customer: " + sqlException.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
            }
            catch(Exception e){
                e.printStackTrace();
            }
